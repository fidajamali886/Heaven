...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkQuery = "SELECT * FROM `Customize Trips` WHERE `d_Email` = '$Email'";
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        $query = "INSERT INTO `Customize Trips` 
        (`d_id`, `d_Name`, `d_Email`, `d_Cellno`, `d_Country`, `d_City`, `d_Participants`, `d_Pickup`, `d_Pickup_date`, `d_Days`, `d_Destination`, `d_Purpose`, `d_Services`,  `d_About`) 
        VALUES (NULL, '$Name', '$Email', '$Cellno', '$Country', '$City', '$Participants', '$Pickup', '$Pickup_date','$Days', '$Destination', '$Purpose', '$Services',  '$About')";
...
<div class="long-line abc"></div>
      ...
      <form id="inquiryForm" method="POST">
        ...
        <label>Total days you have for the trip </label>
        <input type="text" name="Days" placeholder="Total days you have for the trip *" required>
        
        <label>Which Destinations you would like to visit?</label>
        <input type="text" name="Destination" placeholder="Which Destinations you would like to visit?" required>

        <label>What is your ultimate purpose of the trip?</label>
        <input type="text" name="Purpose" placeholder="What is your ultimate purpose of the trip?" required>

        <label>What services level / standard you are looking for?</label>
        <input type="text" name="Services" placeholder="What services level / standard you are looking for?" required>
