...
--
-- Table structure for table `6 Days Family Trip around Skardu`
--

CREATE TABLE `6 Days Family Trip around Skardu` (
...
--
-- Indexes for table `6 Days Family Trip around Skardu`
--
ALTER TABLE `6 Days Family Trip around Skardu`
