...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkQuery = "SELECT * FROM `spantik base trek` WHERE `d_Email` = '$Email'";
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        $query = "INSERT INTO `spantik base trek` 
...
<head>
    <meta charset="utf-8">
    <title>Spantik Base Trek-Haven of The World</title>
...
<!--  Home Link -->
 <div class=" col-lg-12 col-12 abc">
    <a  href="#">Home</a> | Spantik Base Camp Trek
</div>
          ...
          <!-- Carousel Section (75%) -->
            <div class="col-12 col-lg-9">
                <div class="carousel-inner">
                   <div class="carousel-item active">
                      <img src="Spantik-Base-Trek/Images/6.jpg" class="d-block w-100" alt="Slide 1">
                    </div>
                    <div class="carousel-item">
                        <img src="Spantik-Base-Trek/Images/2.jpg" class="d-block w-100" alt="Slide 2">
                    </div>
                    <div class="carousel-item">
                        <img src="Spantik-Base-Trek/Images/3.jpg" class="d-block w-100" alt="Slide 3">
                    </div>
                    <div class="carousel-item">
                        <img src="Spantik-Base-Trek/Images/4.jpg" class="d-block w-100" alt="Slide 4">
                    </div>
                    <div class="carousel-item">
                        <img src="Spantik-Base-Trek/Images/5.jpg" class="d-block w-100" alt="Slide 5">
                    </div>
                   <!-- Navigation Buttons -->
                ...
                <div  style=" margin-left:5%;  width:95%;"class="p">
                      ...
                      <h4>  Spantik Base Camp Trek</h4> 
                      
                       Trip Code&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;TK- 104 <br>
                       Elevation&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;4500 meters <br>
                       Type&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;Hiking | Trekking| Sightseeing <br>
                       Level&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;Easy | Moderate <br>
                       Region&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;Arandu village | Baltistan  <br>
                       Duration&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;15 Days <br>
                       Date&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;July to End of Sep <br>
                       Mode of Transport&emsp;&nbsp;&nbsp;Road  
                       <br><br>

                      <b>Overview</b>
                        <br>
                      Trekking to Spantik base camp provides something new feeling which you may not experience in other trekking routes. It offers a moderate steep trekking route with mixture views of glaciers and green mountains. The route up to Bolocoho camp offers very green while side by side you can see Chogho Lungma Glacier and many 5, 6 thousanders peaks. This trek also provides an opportunity of walking through pure white glaciers for last 2 days; Bolocho campsite to Base camp and next day back. In addition, traveling up to Arandu village is also most adventurous part of this trip. Arandu is the most remote and traditional village in Basha of Shigar District. Road to Arandu is mostly narrow and rough which provides an incredible road adventure too. Overall its best if you looking for an adventurous long route trek with no early booking and planning. It falls in open zone so no early advance booking is needed.                   
                      <br>
                      ...
                      <br>
                      <b>Day 04</b><br>
                      Travel- Skardu to Arandu village- 6-7 Hours- Stay and dine in camping
                      <br>
                      <b>Day 05</b><br>
                      Trek- Arandu to Bukum –5 - 6 hours- Stay and dine in Camping
                      <br>
                      <b>Day 06</b><br>
                      Trek Bukum to Khurmal- 5-6 hours- Stay and dine in Camping
                      <br>
                      <b>Day 07</b><br>
                      Trek- Khurumal to Balocho Camp- 6-7 hours- Stay and dine in Camping
                      <br>
                      <b>Day 08</b><br>
                      Trek- Balcoho to Base Camp – 6-7 hours- Stay and dine in camping
                      <br>
                      <b>Day 09</b><br>
                      Trek- Base camp to Bolocho – 4 hours – Stay and dine in camping
                      <br>
                      <b>Day 10</b><br>
                      Trek- Bolocho to Bukum – 5-6 hours- Stay and dine in Camping
                      <br><br>
                      <b>Day 11</b><br>
                      Trek- Bukum to Arandu- 5 hours- Stay and dine in Camping
                      <br><br>
                      <b>Day 12</b><br>
                      Travel- Arandu to Skardu- 7 hours- Stay and dine at hotel in Skardu
                      <br><br>
                      <b>Day 13</b><br>
                      Travel- Skardu to Chilas – Stay and dine at hotel in Chilas
                      <br><br>
                      <b>Day 14</b><br>
                      Travel- Chilas to Islamabad- 12- 14 hours- Stay at hotel in Islamabad
                      <br><br>
                      <b>Day 15</b><br>
                      ...
                      Advance Payment <b>400 USD</b> per person
            ...
            <div class=" abd col-7 col-md-7 col-lg-3">
               <div style=" margin-top:  5%; width: 90%; height: auto%; background-color: #f0f0f0;" >
                    ...
                    <div class="abe">
                        <h4>Spantik Base Camp Trek</h4>
                        <p> Arandu village, Baltistan  </p>
                        
                        <!-- long-line -->
                        <div class="long-line1"></div>
                        <br>
                        <p><b>Mode of Transport:</b>    Road </p>
                        <p><b>Region:</b>              Arandu village | Baltistan </p>
