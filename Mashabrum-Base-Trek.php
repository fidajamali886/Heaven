...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkQuery = "SELECT * FROM `mashabrum base trek` WHERE `d_Email` = '$Email'";
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        $query = "INSERT INTO `mashabrum base trek` 
...
<head>
    <meta charset="utf-8">
    <title>Mashabtum Base Trek-Haven of The World</title>
...
<!--  Home Link -->
 <div class=" col-lg-12 col-12 abc">
    <a  href="#">Home</a> | Mashabrum Base Trek
</div>
            ...
            <div class="col-12 col-lg-9">
                <div class="carousel-inner">
                   <div class="carousel-item active">
                      <img src="Mashabrum-Base-Trek/Images/1.jpg" class="d-block w-100" alt="Slide 1">
                    </div>
                    <div class="carousel-item">
                        <img src="Mashabrum-Base-Trek/Images/2.jpg" class="d-block w-100" alt="Slide 2">
                    </div>
                    <div class="carousel-item">
                        <img src="Mashabrum-Base-Trek/Images/3.jpg" class="d-block w-100" alt="Slide 3">
                    </div>
                    <div class="carousel-item">
                        <img src="Mashabrum-Base-Trek/Images/4.jpg" class="d-block w-100" alt="Slide 4">
                    </div>
                    <div class="carousel-item">
                        <img src="Mashabrum-Base-Trek/Images/4.jpg" class="d-block w-100" alt="Slide 5">
                    </div>
                   <!-- Navigation Buttons -->
                ...
                <div  style=" margin-left:5%;  width:95%;"class="p">
                      ...
                      <h4> Mashabrum Base Trek</h4> 
                       Trip Code&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;TK- 105 <br>
                       ...
                       Region&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;Hushe Valley | Baltistan  <br>
                      ...
                      <b>Overview</b>
                        <br>
                      This trek leads you to the base camp of the south face of Masherbrum (k-1) Peak- 1821m in Hushe valley. It offers an isolated and easy trekking route which gives you ample opportunities of getting lost in the nature and mountains. It’s one of fascinating treks that you reach above 7000er base camp just in 3 days while you would touch with glaciers in the first day.
                      ...
                      <br>
                      <b>Day 05</b><br>
                      Trek- Hushe to Brum Bruma – 6- 8 hours- Stay and dine in Camping
                      <br>
                      <b>Day 06</b><br>
                      Trek Masherbrum base camp, excursions and back to Brum Bruma- Stay and dine in Camping
                      <br>
                      <b>Day 07</b><br>
                      Trek back- Brum Bruma to Hushe and travel to Skardu
                      <br>
                      <b>Day 08</b><br>
