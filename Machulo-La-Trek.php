...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   $Name = $_POST['Name'];
    ...
    $checkQuery = "SELECT * FROM `machulo la trek` WHERE `d_Email` = '$Email'";
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        $query = "INSERT INTO `machulo la trek` 
...
<head>
    <meta charset="utf-8">
    <title>Machulo La Trek-Haven of The World</title>
...
<!--  Home Link -->
 <div class=" col-lg-12 col-12 abc">
    <a  href="#">Home</a> | K2 View Point Trek
</div>
            ...
            <div class="col-12 col-lg-9">
                <div class="carousel-inner">
                   <div class="carousel-item active">
                      <img src="Machulo/Images/9.jpg" class="d-block w-100" alt="Slide 1">
                    </div>
                    <div class="carousel-item">
                        <img src="Machulo/Images/8.jpg" class="d-block w-100" alt="Slide 2">
                    </div>
                    <div class="carousel-item">
                        <img src="Machulo/Images/7.jpg" class="d-block w-100" alt="Slide 3">
                    </div>
                    <div class="carousel-item">
                        <img src="Machulo/Images/2.jpg" class="d-block w-100" alt="Slide 4">
                    </div>
                    <div class="carousel-item">
                        <img src="Machulo/Images/1.jpg" class="d-block w-100" alt="Slide 5">
                    </div>
                   <!-- Navigation Buttons -->
                ...
                <div  style=" margin-left:5%;  width:95%;"class="p">
                      <h4> K2 View Point Trek</h4> 
                      
                       Trip Code &emsp;&emsp;&emsp;&emsp;&emsp;TK- 106 <br>
                       Elevation&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;5000 meters <br>
                       ...
                       Region&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;Machulo | Baltistan  <br>
                       Duration&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;10 Days <br>
                    ...
                    <br><br>
                      <b>Overview</b>
                        <br>
                      Machulo is a beautiful village in District Ghanche located in Hushe valley at the distance of 15km from Khaplu. The village has a lush green summer pasture and green mountain over its entire western site. There are more than two points, from where K2, Broad Peak and Gasherbrum can be viewed. These viewpoints refer as Machulo- La, which means the top of Machulo. Among of these points, one is famous which called Khoxonmo Hltasa ( Excited/ thrilling view point). Indeed, there are excited view of Machulo, Siachen valley sites, Chorbat valley sites and Ghanche Glaciers and Khaplu town. However, the view of the said mountains is subject to weather clearance. We have 2 service options for this trek.                      <br>
                      ...
                      <br>
                      <b>Day 04</b><br>
                      Travel- Skardu to Machulo- 3 Hours- Trek to StargiShaqthang/ Paxta – 2 hours
                      <br>
                      <b>Day 05</b><br>
                      Trek- Stargi Shaqthang/ Paxta To Qoli Brangsa / Khady Braqbo
                      <br>
                      <b>Day 06</b><br>
                      Trek to view point and back To Qoli Brangsa/ Khady Braqbo
                      <br>
                      <b>Day 07</b><br>
                      Trek back- Qoli Brangsa/ Khady Braqbo To Machulo- and travel to Skardu- Stay and dine at Hotel in Skardu
                      <br>
                      <b>Day 08</b><br>
            ...
            <div class=" abd col-7 col-md-7 col-lg-3">
               <div style=" margin-top:  5%; width: 90%; height: auto%; background-color: #f0f0f0;" >
                    ...
                    <div class="abe">
                        ...
                        <p><b>Region:</b>              Machulo | Baltistan </p>
