...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkQuery = "SELECT * FROM `Corporate Trips` WHERE `d_Email` = '$Email'";
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        $query = "INSERT INTO `Corporate Trips` 
          ...
          <!-- Carousel Section (75%) -->
            <div class="col-12 col-lg-9">
                ...
                <div  style=" margin-left:5%;  width:95%;"class="p">
                  ...
                  Skardu-Baltistan region offers best opportunities for corporate retreat and employees incentives trips as well as family & friends get-together.  Either you plan to have camping nights at Deosai, Kachura, Shigar and Khaplu valleys or want to explore the rich-nature diverse valleys of the region just ask us! As a native adventure based tour operator of the region and having a decade experiences in the field of camping, logistic and traveling business, we at K2 PAKISTAN fully understand your needs, demands and able to exceed your expectations.  Send us an email/ or make a phone call our team will come up with complete detail.
