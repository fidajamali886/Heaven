...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   $Name = $_POST['Name'];
    ...
    $checkQuery = "SELECT * FROM `Skardu Trip` WHERE `d_Email` = '$Email'";
...
<head>
    <meta charset="utf-8">
    <title>Skardu Trip-Haven of The World</title>
            ...
            <div class="col-12 col-lg-9">
                <div class="carousel-inner">
                   <div class="carousel-item active">
                      <img src="Skardu-Trip/Images/6.jpg" class="d-block w-100" alt="Slide 1">
                    </div>
                    <div class="carousel-item">
                        <img src="Skardu-Trip/Images/1.jpeg" class="d-block w-100" alt="Slide 2">
                    </div>
                    <div class="carousel-item">
                        <img src="Skardu-Trip/Images/2.jpeg" class="d-block w-100" alt="Slide 3">
                    </div>
                    <div class="carousel-item">
                        <img src="Skardu-Trip/Images/3.jpeg" class="d-block w-100" alt="Slide 4">
                    </div>
                    <div class="carousel-item">
                        <img src="Skardu-Trip/Images/4.jpeg" class="d-block w-100" alt="Slide 5">
                    </div>
                   <!-- Navigation Buttons -->
                ...
                <div  style=" margin-left:5%;  width:95%;"class="p">
                       ...
                       <h4> Skardu Trip</h4> 
                      <br>
                      Trip Code&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;RT- 201 <br>
                      Type&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;Sightseeing |Culture <br>
                      Destinations&emsp;&emsp;&emsp;&emsp;Skardu| Deosai | Shigar Valley | Khaplu | Hushe Valley <br>
                      Level&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;Demanding | Extreme  <br>
                      Region&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;Baltistan  <br>
                      Duration&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;10 Days & 9 Nights- Islamabad to Islamabad <br>
                      Tentative Date&emsp;&emsp;&emsp;&nbsp;April | May| June | July | Aug| Sep |Oct | Nov <br> 
                      Mode of Transport&emsp;&nbsp;&nbsp;Road <br>  
                 
                    <b>Overview</b>
                      <br>
                    Skardu is capital of Baltistan Division in Gilgit-Baltistan. Skardu is located in between the Karakorum and Himalaya range offering Peaks, River, Lake, Desert, Rocks, and Greenery at a single glance. It is gateway and hub for adventure tourism. Baltistan region has 4 Districts including Skardu, Shigar, Ghanche and Kharmang. The whole region has unique natural beauty and attractions for sightseeing as well as camping sites including Deosai; the 2nd highest plateau in the world! This trip includes sightseeing of all major attractions of Skardu Baltistan region.                   
                    <br><br>
                   <b>Attractions </b><br>
                    Islamabad| Naran | Kaghan| Babusar|Bisham| Chilas| KKH| 3 Mountain Ranges| Nanga Parbat View Point| Roundo| Shangrila Lake| Upper Kachura Lake| Skardu | Cold Desert| Sadpara Lake| Manthal Buddha Rock| Shigar valley| Kharmang Valley| Manthokha Waterfall| Khaplu| Thoqsikhar| Saling| Machulo | Talis| Masherbrum View Point.
                    <br><br>
                    <b>Trip Itinerary</b><br>
                    <b>Day 01</b><br>
                    Early morning Pick up at Islamabad airport- Travel- Islamabad to Chilas 12 hours- Stay and dine at hotel in Chilas                    <br>   
                    <b>Day 02</b><br>
                    Travel- Chilas to Skardu - 12 hours- Stay and dine at hotel in Skardu
                    <br>
                    <b>Day 03</b><br>
                    Travel and Sightseeing around Skardu- Visit Bazar, Kachura and Shangri-La Lakes – Cold Desert- Manthokha waterfall- Stay and dine at hotel in Skardu                    <br>
                    <b>Day 04</b><br>
                    Travel- Skardu to Deosai- Deosai excursion and back to Skardu- Stay and dine at hotel in Skardu
                    <br>
                    <b>Day 05</b><br>
                    Travel- Skardu to Khaplu- While traveling to Khaplu we will visit Manthokha waterfall, as well as stop by at different points and palaces and in the evening get to Khaplu. Stay and dine at hotel in Khaplu
                    <br>
                    <b>Day 06</b><br>
                    Travel and visit Thoqsikhar- Travel to Hanjur side and view, Travel to Hushe valley up to Machulo and Talis village. Travel back to Khaplu- Stay and dine at hotel in Khaplu
                    <br>
                    <b>Day 07</b><br>
                    Travel- Khaplu to Shigar valley- Sightseeing in the valley and Travel to Skardu in the evening. Stay and dine at hotel in Skardu
                    <br>
                    <b>Day 08</b><br>
                    Early Morning travel- Skardu to Chilas- 10-12 hours- Stay and dine at hotel in Chilas
                    <br>
                    <b>Day 09</b><br>
                    Travel back- Chilas to Islamabad- Stay and dine at hotel in Islamabad
                    <br>
                    <b>Day 10</b><br>
                    Sightseeing and shopping – late night departure- Drop at Islamabad airport- No hotel stay
                    <br><br>
                    <b>Services Included</b><br> 
                    Islamabad airport pick and drop <br>
                    Private booked road transport from Islamabad to Skardu <br>
                    All hotel nights as per itinerary <br>
                    Trekking Guide, Local Porters <br>
                    Kitchen Crews <br>
                    Dome Tents - 2/3 sharing- always come with mattress <br>
                    Kitchen & Mess Tents <br>
                    All meal during tours at restaurants / hotels <br>
                    Mineral water and Soft drinks during lunch and dinner at restaurant/ hotel <br>
                    All meal during trek prepared and cooked by our professional team and chef <br>
                    Snacks during trek <br>
                    Boiled water during trek <br>
                    6 kg personal porters 
                    <br><br>
                    ...
                    Advance Payment <b>320 USD</b> per person
            ...
            <div class=" abd col-7 col-md-7 col-lg-3">
               <div style=" margin-top:  5%; width: 90%; height: auto%; background-color: #f0f0f0;" >
                    ...
                    <div class="abe">
                        ...
                        <p><b>Region:</b>               Gilgit-Baltistan  </p>
