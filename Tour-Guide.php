...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkQuery = "SELECT * FROM `Tour Guide` WHERE `d_Email` = '$Email'";
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        $query = "INSERT INTO `Tour Guide` 
        (`d_id`, `d_Name`, `d_Email`, `d_Cellno`, `d_Country`, `d_City`, `d_participants`, `d_Nights`, `d_Days`, `d_Guide`, `d_About`) 
        VALUES (NULL, '$Name', '$Email', '$Cellno', '$Country', '$City', '$participants', '$Nights', '$Days', '$Guide', '$About')";
...
<div class=" col-lg-12 col-12 abc">
    <a  href="../Home.php">Home</a> | Tour Guides
</div>
...
Traveling without guides is watching documentary without voice! K2 Pakistan offers travel guides all around Skardu and Hunza region. We have native professional guides as well as volunteers who make traveling informative and learning so does lead your trips with complete care and safety.
                </div>
      ...
      <form id="inquiryForm" method="POST">
        ...
        <input type="text" name="Nights" placeholder="No of Nights" required>

        <label>Days</label>
        <input type="text" name="Days" placeholder="Days" required>
        
        <label>Guide</label><br>
        <select style="width:20% ;background-color: blanchedalmond;" name="Guide" id="Guide" placeholder="Guide" required>
        <option value=""></option>
        <option value="Travel Guide">Travel Guide</option>
        <option value="Volunteer Guide">Volunteer Guide</option>
        </select>
      <br>
