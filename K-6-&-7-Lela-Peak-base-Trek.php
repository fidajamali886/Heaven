...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkQuery = "SELECT * FROM `k-6 & 7 lela peak base trek` WHERE `d_Email` = '$Email'";
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        $query = "INSERT INTO `k-6 & 7 lela peak base trek` 
...
<head>
    <meta charset="utf-8">
    <title>K-6 K-7 La Peak Base-Haven of The World</title>
...
<!--  Home Link -->
 <div class=" col-lg-12 col-12 abc">
    <a  href="#">Home</a> | K-7 | Leal Peak Trek
</div>
            ...
            <div class="col-12 col-lg-9">
                <div class="carousel-inner">
                   <div class="carousel-item active">
                      <img src="K-6-&-7-Lela-Peak-base-Trek/Images/1.jpg" class="d-block w-100" alt="Slide 1">
                    </div>
                    <div class="carousel-item">
                        <img src="K-6-&-7-Lela-Peak-base-Trek/Images/2.jpg" class="d-block w-100" alt="Slide 2">
                    </div>
                    <div class="carousel-item">
                        <img src="K-6-&-7-Lela-Peak-base-Trek/Images/3.jpg" class="d-block w-100" alt="Slide 3">
                    </div>
                    <div class="carousel-item">
                        <img src="K-6-&-7-Lela-Peak-base-Trek/Images/4.jpg" class="d-block w-100" alt="Slide 4">
                    </div>
                    <div class="carousel-item">
                        <img src="K-6-&-7-Lela-Peak-base-Trek/Images/5.jpg" class="d-block w-100" alt="Slide 5">
                    </div>
                   <!-- Navigation Buttons -->
                ...
                <div  style=" margin-left:5%;  width:95%;"class="p">
                      ...
                      <h4> K-7 | Leal Peak Trek</h4> 

                       Trip Code&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;TK- 107 <br>
                       ...
                       Duration&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;12 Days <br>
                       Date&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;Choose your own date <br>
                  ...
                  <br><br>
                    <b>Overview</b>
                      <br>
                    K-6 and K-7 are famous peaks located in Charaksa valley glacier in Hushe valley while Leila Peak is the most beautiful peak of Karakoram situated in Ghandoghoro valley. Both trekking routes are easy and moderate, however a bit hard than Masherbrum Peak base camp trek. The K-6-7 route is more less traveled and calm compare to Ghandoghoro Leila Peak trek. The first day trek is same for both treks up to Shaicho camp. Then the left route goes to Ghodhogoro valley for Khiuspang Lela Peak site while to right side K-6 and 7. Trekking up to Khiuspang offers closed view of Leila Peak, K-1. Khiuspang is the base camp of Ghandhgoro Pass of Hushe side. Having K-6 and K-7 trek would also offer you to see Link Sar, Drifica, Kapora peaks. Our price and itinerary are same for the both trekking route, however if you don’t want to miss both and ask us both treks in one way, we charge an extra of 290/-USD and 3 more days in the existing itinerary.                    <b>Trip Itinerary</b><br>
                    <b>Day 01</b><br>
                    Reception at Islamabad airport and transfer to Hotel
                    <br>   
                    <b>Day 02</b><br>
                    Early Travel- Islamabad to Chilas, either Naran Babusar route or Bisham KKH Route- Stay and Dine at hotel in Chilas – 12 hours traveling                    <br>
                    <b>Day 03</b><br>
                    ...
                    <br>
                    <b>Day 05</b><br>
                    Trek- Hushe to Shaicho – 4- 5 hours- Stay and dine in Camping
                    <br>
                    <b>Day 06</b><br>
                    Trek Shaicho to Spangsar- K6-7 Option <br>
                    Trek- Shaicho to Gholong- Leila Peak option <br>
                    <b>Day 07</b><br>
                    Trek- Spangsar to K6-7 base camp K6-7 Option <br>
                    Trek- Gholong to Khiuspang Base Leila Peak option <br>
                    <b>Day 08</b><br>
                    Trek back to Shaicho
                    <br>
                    <b>Day 09</b><br>
