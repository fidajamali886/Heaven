...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkQuery = "SELECT * FROM `7 Days Family Trip around Skardu` WHERE `d_Email` = '$Email'";
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        $query = "INSERT INTO `7 Days Family Trip around Skardu` 
...
<!--  Home Link -->
 <div class=" col-lg-12 col-12 abc">
    <a  href="/Home.php">Home</a> | 7 Days Family Trip around Skardu
</div>
            ...
            <div class="col-12 col-lg-9">
                <div class="carousel-inner">
                   <div class="carousel-item active">
                      <img src="3-Days-Family-Trip-around-Skardu/Images/1.jpg" class="d-block w-100" alt="Slide 1">
                    </div>
                    <div class="carousel-item">
                        <img src="3-Days-Family-Trip-around-Skardu/Images/10.jpg" class="d-block w-100" alt="Slide 2">
                    </div>
                    <div class="carousel-item">
                        <img src="3-Days-Family-Trip-around-Skardu/Images/11.jpg" class="d-block w-100" alt="Slide 3">
                    </div>
                    <div class="carousel-item">
                        <img src="3-Days-Family-Trip-around-Skardu/Images/12.jpg" class="d-block w-100" alt="Slide 4">
                    </div>
                    <div class="carousel-item">
                        <img src="3-Days-Family-Trip-around-Skardu/Images/13.jpg" class="d-block w-100" alt="Slide 5">
                    </div>
                   <!-- Navigation Buttons -->
                ...
                <div  style=" margin-left:5%;  width:95%;"class="p">
                      ...
                      <h4>7 Days Family Trip around Skardu</h4> 
                    <br>
                    Trip Code  &emsp;&emsp;&emsp;&emsp;RT-404 <br> 
                    ...
                    Duration &emsp;&emsp;&emsp;&emsp;&nbsp;      7 Days 6 Nights – Skardu to Skardu <br>
                    Service Level &emsp;&emsp;&nbsp;&nbsp;  Economy Plus | VIP (both available) <br> 
                    Traveling &emsp;&emsp;&emsp;&emsp;&nbsp;      5–6 hours daily (or depending on your mood) <br> 
                    Date &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;             Choose your own date <br>
                    <br>
                  
                    <b>Trips Attractions | Destinations to be visited</b><br>
                    Skardu| Shangrila | Upper Kachura Lake|Kachura Xoq| Deosai Plain| Manthal Buddha Rock | Sadpara Lake| Cold Deserts| Katpana Lake | Shigar Fort | Shigar Valley |Manthokha Waterfall | Khaplu Valley | Khaplu Fort|Khanqah Khaplu| Thoqsikhar| Chaqchan Mosque | Saling| Saling Fish Farm | Machulo | Mashabrum View Point Machulo                    <br><br>
                    ...
                    <br>
                    <b>Day 04</b><br>
                    Travel- Khaplu to Machulo - View Masherbrum Peak – travel back to Saling. Travel back to Khaplu - Visit Thoqsikhar- from the top the view of Khaplu town and other valleys is amazing- Stay and Dine at Khaplu
                    <br>
                    <b>Day 05</b><br>
                    Hotel Check out and Travel to Skardu- Visit Katpana Lake, Cold desert and Manthal Buddha rock in evening- Visit Skardu Bazar and Shopping - Stay and Dine at Skardu
                    <br>
                    <b>Day 06</b><br>
                    Travel and visit Shigar valley. Visit Shigar and Sightseeing valley. Travel back to Skardu. Stay and dine in Skardu City
                    <br>
                    <b>Day 07</b><br>
                    Drop at Skardu Airport for Departure.
                    <br><br>
                    <b>Services Included</b><br> 
                    7 Days Private Booked Transport throughout the tour for sightseeing <br>
                    6 Nights hotel stay as per the itinerary <br>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <form id="inquiryForm" method="POST">
        ...
        <input type="text" name="v" placeholder="No of participants" required>
