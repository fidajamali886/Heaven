...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   $Name = $_POST['Name'];
    ...
    $checkQuery = "SELECT * FROM `hunza trip` WHERE `d_Email` = '$Email'";
...
<head>
    <meta charset="utf-8">
    <title>Hunza Trip-Haven of The World</title>
...
<!--  Home Link -->
 <div class=" col-lg-12 col-12 abc">
    <a  href="#">Home</a> | <a  href="#">Ture</a> | Biafo Hisper Epic
</div>
          ...
          <!-- Carousel Section (75%) -->
            <div class="col-12 col-lg-9">
                <div class="carousel-inner">
                   <div class="carousel-item active">
                      <img src="Hunza-Trip/Images/10.jpg" class="d-block w-100" alt="Slide 1">
                    </div>
                    <div class="carousel-item">
                        <img src="Hunza-Trip/Images/15.jpg" class="d-block w-100" alt="Slide 2">
                    </div>
                    <div class="carousel-item">
                        <img src="Hunza-Trip/Images/7.jpg" class="d-block w-100" alt="Slide 3">
                    </div>
                    <div class="carousel-item">
                        <img src="Hunza-Trip/Images/11.jpg" class="d-block w-100" alt="Slide 4">
                    </div>
                    <div class="carousel-item">
                        <img src="Hunza-Trip/Images/12.jpg" class="d-block w-100" alt="Slide 5">
                    </div>
                   <!-- Navigation Buttons -->
                ...
                <div  style=" margin-left:5%;  width:95%;"class="p">
                      ...
                      <h4>  Hunza Trip</h4> 
                      <br>
                      Trip Code&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;RT- 203 <br>
                      Type&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;Sightseeing |Culture <br>
                      Destinations&emsp;&emsp;&emsp;&emsp;&nbsp;Hunza| Karimabad| Passu| Khunjarab pass| Gilgit <br>
                      Level&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;Demanding | Extreme <br>
                      Region&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;Gilgit-Baltistan <br>
                      Duration&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;8 Days 7 Nights <br>
                      Tentative Date&emsp;&emsp;&emsp;&nbsp;&nbsp;April | May| June | Sep |Oct | Nov <br>
                      Mode of Transport&emsp;&nbsp;&nbsp;Road  <br>
                  
                    <b>Overview</b>
                      <br>
                    Hunza is an iconic name of Pakistan’s tourism industry.  It has an amazing natural and cultural beauty.
                    <br><br>
                   <b>Attractions </b><br>
                    Naran | Kaghan | KKH |Mehnsera | Bisham| Babusar Pass| Chilas|3 ranges Junction point| Nanga Parbat view point| Rakaposhi | Lady Finger Peak| Gilgit| Hunza| Karimabad| Ataabad Lake, Altit/ Baltit Forts| Passu Cones| Husseini Bridge | Pak-China Border.
                    <br><br>
                    <b>Trip Itinerary</b><br>
                    <b>Day 01</b><br>
                    Early morning reception at Islamabad airport- Travel to Bisham/ Naran- Stay and dine at hotel in in Bisham/ Naran
                    <br>
                    <b>Day 02</b><br>
                    Travel- Bisham/ Naran to Hunza - 10- 12 hours- Stay and Dine at Hotel in Karimabad Hunza
                    <br>
                    <b>Day 03</b><br>
                    Travel and Sightseeing in Karimabad Hunza- Visit Altit and Baltit Forts- Visit Eagle nest
                    <br>
                    <b>Day 04</b><br>
                    Travel- Karimabad to Pak- China Border- Travel back to Sost/ Passu for overnight stay
                    <br>
                    <b>Day 05</b><br>
                    Travel- Passu to Hunza/ Gilgit- Stay and Dine at Hunza/ Gilgit – 8- 10 hours
                    <br>
                    <b>Day 06</b><br>
                    Travel back- Hunza/ Gilgit to Naran/ Bisham- 8-10 hours- Stay and Dine at hotel in Bisham or Naran
                    <br>
                    <b>Day 07</b><br>
                    Travel- Bisham/ Naran to Islamabad- - 10- 12 hours- Stay at hotel in Islamabad
                    <br>
                    <b>Day 08</b><br>
                    Drop at Islamabad airport for international departure- No hotel stay
            ...
            <div class=" abd col-7 col-md-7 col-lg-3">
               <div style=" margin-top:  5%; width: 90%; height: auto%; background-color: #f0f0f0;" >
                    ...
                    <div class="abe">
                        <h4> Hunza Trip</h4>
                        <p>Gilgit-Baltistan, Hunza, </p>
                        
                        <!-- long-line -->
                        <div class="long-line1"></div>
                        <br>
                        <p><b>Mode of Transport:</b>    Road & Air</p>
                        <p><b>Region:</b>              Hunza| Karimabad| Khunjarab pass  </p>
