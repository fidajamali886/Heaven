...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkQuery = "SELECT * FROM `transports` WHERE `d_Email` = '$Email'";
            ...
            <div class="col-12 col-lg-9">
                <div class="carousel-inner">
                   <div class="carousel-item active">
                      <img src="Transports/Images/1.jpeg" class="d-block w-100" alt="Slide 1">
                    </div>
                    <div class="carousel-item">
                        <img src="Transports/Images/2.jpg" class="d-block w-100" alt="Slide 2">
                    </div>
                    <div class="carousel-item">
                        <img src="Transports/Images/3.jpeg" class="d-block w-100" alt="Slide 3">
                    </div>
                    <div class="carousel-item">
                ...
                <div  style=" margin-left:5%;  width:95%;"class="p">
                      ...
                      We provide transport services for sightseeing trips around Skardu, Khaplu, Shigar, Deosai and Hunza valleys. We offer all kinds of Parado and Cars and also  native drivers who are familiar with all tourists’ attractions throughout Gilgit- Baltistan region and able to lead your trip with complete care and safety!
                      <br>
                      Please note, the following is our regular price chart. However, sometimes increased/ decreased in demand factors apply too!
                      <br><br>
                     <b> Vehicle & Price Charts </b>
                     <br><br>
                      <table class="table table-bordered table-striped">
            <thead class="table-light">
                <tr>	 	 
                    <th>Vehicles  Type</th>
                    <th>Per Day without Fuel</th>
                    <th>Per Day with Fuel	</th>
                    <th>Minimum Days</th>                    
                </tr>
                <tr>			
                  <td>Parado Up Model</td>
                  <td>PKR- 8000</td>
                  <td>PKR- 12500</td>
                  <td>03</td>
                </tr>
                <tr>			
                  <td>Parado Down Model</td>
                  <td>PKR- 6000</td>
                  <td>PKR- 9000</td>
                  <td>03</td>
                </tr>
            ...
            <div class=" abd col-7 col-md-7 col-lg-3">
               <div style=" margin-top:  5%; width: 90%; height: auto%; background-color: #f0f0f0;" >
                    ...
                    <div class="abe">
                       ...
                       We offer transport services for sightseeing trips around Skardu, Khaplu, Shigar, Deosai and Hunza valleys. <br><br>
