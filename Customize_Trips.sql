...
--
-- Table structure for table `Customize Trips`
--

CREATE TABLE `Customize Trips` (
...
--
-- Indexes for table `Customize Trips`
--
ALTER TABLE `Customize Trips`
...
--
-- AUTO_INCREMENT for table `Mountaineering`
--
ALTER TABLE `Customize Trips`
