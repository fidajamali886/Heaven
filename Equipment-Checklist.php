...
<!--  Home Link -->
 <div class=" col-lg-12 col-12 abc">
    <a  href="../Home.php">Home</a> | Equipment Checklist
</div>
...
<div  style=" margin-left:5%;  width:95%; font-size: larger;"class="p">
             ...
             <h4>Personal Cloths| Equipment’s Recommended for Trekking in Pakistan</h4>
      <li>Personal first aid kits and medication  </li> 
      <li> Backpack (with rainproof  cover) (Medium /small size)  </li>  
      <li>One duffel bag between two  </li>
      <li>One Trekking Boot and one Jogger  </li>
      <li>One light slipper (chappal)  </li>
      <li>Sleeping Bag- Preferably feather filled and light weight </li>
      <li>One Sleeping Mattress   </li>
      <li>One or two Warm Jacket   </li>
      <li>Rain Jacket  </li>
      <li>Down Jacket normal  </li>
      <li>One warm Cap also one Sun Hat </li>
      <li>Two or three trekking trousers  </li>
      <li>Glasses  </li>
      <li>Full sleeves shirts- two or three </li>
      <li>One or two warm sweeter – fleece  </li>
      <li>One or two inner (warm Trousers and inner warm shirt)  </li>
      <li>Socks  </li>
      <li>Gloves  </li>
      <li>Pocket Knife  </li>
      <li>Scarf/ Muffler  </li>
      <li>Head Torch and extra cell  </li>
      <li>Sun block creams and lips slave  </li>
      <li>Water Bottle  </li>
      <li>Trekking pole   </li>
      <li>Personal Hygiene kit  and toiletries  </li>
      <li>Cloth washing bag  </li>
      <li>Repair kit ( Needle, Thread etc)  </li>
      <li>Chocolate  </li>
      <li>Camera if have and extra cells  </li>
      <li>Umbrella  </li>
      <li>Books for reading and travel diary notebook ,pen  </li>
      <li>Walki– talki (Optional) </li>
      <li>Thuraya Phone (Optional )  </li>
      <li>Your country  Flag  </li>
      <li>Passports</li>
      <br>
      <h4> Additional recommended list for Ghandoghoro Pass and Biafo Hisper Trek </h4>
      <li>Crampon </li>
      <li>Mountaineering Boot Comfortable with your Crampon  </li>
      <li>Harness  </li>
      <li>Carbineer </li>
