...
<!--  Home Link -->
 <div class=" col-lg-12 col-12 abc">
    <a  href="#">Home</a>  | Mountaineering Expeditions
</div>
...
<div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
    <div class="container1-fluid">
            ...
            <div class="col-12 col-lg-9">
                <div class="carousel-inner">
                   <div class="carousel-item active">
                      <img src="Mountaineering/Images/7.png" class="d-block w-100" alt="Slide 1">
                    </div>
                    <div class="carousel-item">
                        <img src="Mountaineering/Images/2.jpg" class="d-block w-100" alt="Slide 2">
                    </div>
                    <div class="carousel-item">
                        <img src="Mountaineering/Images/3.jpg" class="d-block w-100" alt="Slide 3">
                    </div>
                    <div class="carousel-item">
                        <img src="Mountaineering/Images/4.jpg" class="d-block w-100" alt="Slide 4">
                    </div>
                    <div class="carousel-item">
                        <img src="Mountaineering/Images/5.jpg" class="d-block w-100" alt="Slide 5">
                    </div>
                   <!-- Navigation Buttons -->
                ...
                <div  style=" margin-left:5%;  width:95%;"class="p">
                      ...
                      <h4> Mountaineering Expeditions</h4> 
                       <br>
                    Skardu is capital of adventure tourism. It’s a gateway to all mountaineering expeditions of Karakorum Range including K2, Gasherbrum range, Broad Peak, Trango Group, Spantik, Masherbrum, Lela Peak, K6 and 7 and many other peaks of above 6 and 7 thousandsers!
                    <br><br>
                    As a native and local tour operator based in Skardu-Baltistan, having extensive experiences in handling mountaineering expeditions we completely understands all your climbing needs and committed to exceed!
                    <br><br>
                    You can find a short sketch of some of the most famous climbing peaks of Karakorum, price range and duration while upon request you may get the complete proposals.
                    <br><br>
                    Please note our price are all inclusive within Pakistan such as airport Transfer, hotel accommodations, flights Islamabad – Skardu route, all road transportation, foods & meal, logistic equipment during trek and to base camps, porters, guides and crews.
                    <br><br>
                    In addition, besides the following enlisted mountains Pakistan has so many 6 & 7 thousanders peaks, even un-climbed too! Ask us, get tailored proposals and climb any peaks/ mountains of Karakorum & Himalaya of Pakistan, we are ready to be your climbing partners!
                  <br><br><br><br>
                  <h3>Above 80000m Mountains & Price </h3>
                  <br>
        ...
        <br><br>
                  <h3>Above 6 & 7 thousands meters Peaks & Price </h3>
                  <br>
        <table class="table table-bordered table-striped">
            <thead class="table-light">
                <tr>	 	 
                ...
                <tr>						
                  <td>EXP8- 306</td>
                  <td>Spantik Peak-  7027m</td>
                  <td>July 10 Aug 05</td>
                  <td>Max 35</td>
                  <td>6000/- USD	</td>
            ...
            <div class=" abd col-7 col-md-7 col-lg-3">
               <div style=" margin-top:  5%; width: 90%; height: auto%; background-color: #f0f0f0;" >
                    ...
                    <div class="abe">
                        ...
                        Mountaineering 
                        <br>
                        Skardu is capital of adventure tourism.  It’s a gateway of all mountaineering expeditions of Karakorum Range including K2, Gasherbrum range, Broad Peak, Trango Group, Spantik, Masherbrum, Lela Peak, K6 and 7 and many other peaks of above 6 and 7 thousandsers. As a native and local tour operator based in Skardu-Baltistan, we completely understands all your climbing expedition needs and committed to exceed!
                        <br> <br>
