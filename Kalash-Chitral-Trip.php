...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkQuery = "SELECT * FROM `Kalash Chitral trip` WHERE `d_Email` = '$Email'";
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        $query = "INSERT INTO `Kalash Chitral trip` 
...
<head>
    <meta charset="utf-8">
    <title>Kalash Chitral Trip-Haven of The World</title>
...
<!--  Home Link -->
 <div class=" col-lg-12 col-12 abc">
    <a  href="/Home.php">Home</a> | Kalash Chitral Trip
</div>
          ...
          <!-- Carousel Section (75%) -->
            <div class="col-12 col-lg-9">
                ...
                <div  style=" margin-left:5%;  width:95%;"class="p">
                       ...
                       <h4> Kalash Chitral Trip</h4> 
                      <br>
                      Trip Code&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;RT- 205 <br>
                      Type&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;Sightseeing |Culture <br>
                      Destinations&emsp;&emsp;&emsp;&emsp;&nbsp;Chitral | Kalasha | Shandur <br>
                      ...
                      Tentative Date&emsp;&emsp;&emsp;&nbsp;&nbsp;May| July <br>
                      Mode of Transport&emsp;&nbsp;&nbsp;Road 
                       
                    <br><br>
                    <b>Overview</b>
                      <br>
                    Kalash valley is located in Chital District Huinkush range of Pakistan. It’s a unique tribe have a beautiful cultures and way of life. They have 3 traditional festivals which of them Chilum Joshi is very famous that celebrate between 15 to 20 May each year.
                    <br><br>
                    ...
                    <br>
                    <b>Day 02</b><br>
                    Early Travel- Islamabad to Chitral - Stay and Dine at hotel in Chitral – 12 hours traveling
                    <br>
                    <b>Day 03</b><br>
                    Travel- Chitral to Rumbur Valley- 4 hours- Stay and dine at hotel/ Camping and Rumbur valley
                    <br>
                    <b>Day 04</b><br>
                    Travel and Visit Bumburet valley- Stay and dine at hotel/ Camping at Bumburet valley
                    <br>
                    <b>Day 05</b><br>
                    Early Morning to Chitral- Sightseeing in Chitral or travel to Shandur- Stay and dine at hotel in Chitral or at camping in Shandur Pasture
                    <br>
                    <b>Day 06</b><br>
                    Travel Back to Chitral- Stay and dine at hotel in Chitral
                    <br>
                    <b>Day 07</b><br>
                    Travel back to Islamabad- 12 hours
                    <br>
                    <b>Day 08</b><br>
            ...
            <div class=" abd col-7 col-md-7 col-lg-3">
               <div style=" margin-top:  5%; width: 90%; height: auto%; background-color: #f0f0f0;" >
                    ...
                    <div class="abe">
                        <h4>Kalash Chitral Trip</h4>
                        <p>Gilgit-Baltistan, Chitral, </p>
                        
                        <!-- long-line -->
                        <div class="long-line1"></div>
                        <br>
                        <p><b>Mode of Transport:</b>    Road </p>
                        <p><b>Region:</b>               Gilgit-Baltistan | Chitral </p>
