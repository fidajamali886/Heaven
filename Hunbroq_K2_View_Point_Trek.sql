...
--
-- Table structure for table `Hunbroq K2 View Point Trek`
--

CREATE TABLE `Hunbroq K2 View Point Trek` (
...
--
-- Indexes for table `Hunbroq K2 View Point Trek`
--
ALTER TABLE `Hunbroq K2 View Point Trek`
...
--
-- AUTO_INCREMENT for table `Hunbroq K2 View Point Trek`
--
ALTER TABLE `Hunbroq K2 View Point Trek`
