...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkQuery = "SELECT * FROM `Hunbroq K2 View Point Trek` WHERE `d_Email` = '$Email'";
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        $query = "INSERT INTO `Hunbroq K2 View Point Trek` 
...
<head>
    <meta charset="utf-8">
    <title>Hunbroq K2 View Point-Haven of The World</title>
...
<!--  Home Link -->
 <div class=" col-lg-12 col-12 abc">
    <a  href="#">Home</a> | Hushe Hunbroq Trek
</div>
            ...
            <div class="col-12 col-lg-9">
                <div class="carousel-inner">
                   <div class="carousel-item active">
                      <img src="Hunbroq/Images/4.jpeg" class="d-block w-100" alt="Slide 1">
                    </div>
                ...
                <div  style=" margin-left:5%;  width:95%;"class="p">
                      ...
                      <h4> Hushe Hunbroq Trek</h4> 
                      
                       Trip Code&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;TK- 108 <br>
                  ...
                  <br><br>
                    <b>Overview</b>
                      <br>
                    Hunbroq is the base camp of K2 view point as well as a summer pasture of Hushe village where the community keeps their animals and cows and produce butter over there. It’s a steep route trek for almost 4 hours in order to get to Hunbroq, while from Hunbroq to view point required one more day. This trek is unique where you can also have some cultural experience of the traditional culture of Hushe having interaction with people including kids at Hunbroq.                    <br>
                    ...
                    <br>   
                    <b>Day 02</b><br>
                    Flight to Skardu, In case of flight cancelation, we will travel by road through KKH having a night stay in Chilas.
                    <br>
                    <b>Day 03</b><br>
                    ...
                    <br>
                    <b>Day 05</b><br>
                    Trek- Hushe to Hunbroq – 4- 5 hours- Stay and dine in Camping
                    <br>
                    <b>Day 06</b><br>
            ...
            <div class=" abd col-7 col-md-7 col-lg-3">
                 <div style="  margin-top:  5%; width: 90%; height: auto%; background-color: #f0f0f0;" >
                    ...
                    <div class="abe">
                        ...
                        <p><b>Region:</b>               Hushe | Baltistan </p>
