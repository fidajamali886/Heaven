...
if (isset($_POST['submit'])) {
    ...
    // $query = "INSERT INTO `class8` (`d_id`, `d_fname`, `d_lname`, `d_grade`) VALUES (Null, '$fname', '$lname', '$grade')";
    $query = "INSERT INTO `Gushing la trek` (`d_id`, `d_Name`, `d_Email`, `d_Cellno`, `d_Country`, `d_City`, `d_Participents`, `d_Picup`, `d_Picdate`, `d_About`) VALUES (NULL, '$Name', '$Email', '$Cellno', '$Country', '$City', '$Participents', '$Picup', '$Picdate', '$About')";
...
<?php if ($msg != ""): ?>
    <div id="msgBox" style="color: green;margin-left:5%;  font-weight: bold;">
        <?php echo $msg; ?>
        <p style="font-weight: normal;margin-left:0%; color:black">Thank you! Your information has been successfully submitted.</p>
...
<form action="" id="myForm" method="post">
    ...
    <input type="date" name="Picdate" id="picdate" placeholder="year/month/days "required> <br>
    <label for="">What you would like to inquire about?  </label> <br>
    <input type="text" name="About"  placeholder="What you would like to inquire about? "required> <br>
