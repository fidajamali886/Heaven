...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkQuery = "SELECT * FROM `6 Days Family Trip around Skardu` WHERE `d_Email` = '$Email'";
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        $query = "INSERT INTO `6 Days Family Trip around Skardu` 
...
<head>
    <meta charset="utf-8">
    <title>6-Days Family Trip around Skardu-Haven of The World</title>
...
<!--  Home Link -->
 <div class=" col-lg-12 col-12 abc">
    <a  href="#">Home</a> |  6 Days Family Trip around Skardu
</div>
          ...
          <!-- Carousel Section (75%) -->
            <div class="col-12 col-lg-9">
                ...
                <div  style=" margin-left:5%;  width:95%;"class="p">
                     ...
                     <h3>6 Days Family Trip around Skardu</h3> 
                    <br>
                    Trip Code  &emsp;&emsp;&emsp;&emsp;RT-403 <br> 
                    ...
                    Duration &emsp;&emsp;&emsp;&emsp;&nbsp;      6 Days 5 Nights – Skardu to Skardu <br>
                    ...
                    Travel- Khaplu to Machulo - View Masherbrum Peak – travel back to Saling. Travel back to Khaplu - Visit Thoqsikhar- from the top the view of Khaplu town and other valleys is amazing- Stay and Dine at Khaplu                   
                     <br>
                    <b>Day 05</b><br>
                    Hotel Check out and Travel to Skardu- Travel to Manthokha Waterfall while coming back-  Travel  to Skardu-  Visit Katpana Lake, Cold desert and Manthal Buddha rock in  evening- Visit Skardu Bazar and Shopping - Stay and Dine at Skardu                   
                     <br>
                    <b>Day 06</b><br>
                    Drop at Skardu Airport for Departure
                    <br><br>
                    <b>Services Included</b><br> 
                    6 Days Private Booked Transport throughout the tour for sightseeing <br>
                    5 Nights hotel stay as per the itinerary <br>
            ...
            <div class=" abd col-7 col-md-7 col-lg-3">
               <div style=" margin-top:  5%; width: 90%; height: auto%; background-color: #f0f0f0;" >
                    <!-- Your content here -->
                    <div class="abe">
                        <h4>6 Days Family Trip around Skardu</h4>
                        <p>Baltistan </p>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <form id="inquiryForm" method="POST">
        ...
        <p style="margin-left:2.5%;">Please complete the form below to send us your message directly.</p>        <?php if (!empty($msg)): ?>
