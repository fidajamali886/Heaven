...
--
-- Table structure for table `K-6 & 7 Lela Peak base Trek`
--

CREATE TABLE `K-6 & 7 Lela Peak base Trek` (
...
--
-- Indexes for table `K-6 & 7 Lela Peak base Trek`
--
ALTER TABLE `K-6 & 7 Lela Peak base Trek`
...
--
-- AUTO_INCREMENT for table `K-6 & 7 Lela Peak base Trek`
--
ALTER TABLE `K-6 & 7 Lela Peak base Trek`
